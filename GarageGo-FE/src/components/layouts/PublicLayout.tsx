                ...
                <li style={{ position: 'relative' }}>
                  {isAuthenticated && user ? (
                      ...
                      <div style={{
                        ...
                        <div style={{ padding: '8px 0' }}>
                          ...
                          onMouseOut={(e) => {
                            ...
                            <i className="fas fa-shopping-bag" style={{ marginRight: '8px', width: '16px' }}></i>
                            Lịch sử đơn hàng
                          </Link>
                          <Link to="/customer/service-requests" style={{
                            display: 'flex',
                            alignItems: 'center',
                            padding: '8px 16px',
                            color: '#374151',
                          ...
                          onMouseOut={(e) => {
                            ...
                            <i className="fas fa-clipboard-list" style={{ marginRight: '8px', width: '16px' }}></i>
                          ...
                          >
                            <i className="fas fa-sign-out-alt" style={{ marginRight: '8px', width: '16px' }}></i>
                            Đăng xuất
                          </button>
                        </div>
                      </div>
                    ...
                    <Link to="/auth/login" style={{
                      ...
                      <span style={{ fontSize: '14px' }} className="d-none d-md-inline">Đăng nhập</span>
                    </Link>
                  )}
                </li>
              </ul>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                Hệ thống quản lý gara ô tô chuyên nghiệp, cung cấp dịch vụ sửa chữa và bảo dưỡng xe hơi chất lượng cao.
              </p>
              <div style={{
                display: 'flex',
                gap: '1rem'
            ...
            <div>
              ...
              <div style={{
                ...
                <i className="fas fa-phone" style={{ marginRight: '0.5rem', width: '16px' }}></i>
                0123 456 789
              </div>
              <div style={{
                display: 'flex',
                ...
                <i className="fas fa-envelope" style={{ marginRight: '0.5rem', width: '16px' }}></i>
                info@mtproauto.com
              </div>
              <div style={{
                display: 'flex',
                ...
                <i className="fas fa-map-marker-alt" style={{ marginRight: '0.5rem', width: '16px' }}></i>
