...
export const HomePage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      name: 'Thay dầu máy',
      price: 300000,
      description: 'Thay dầu nhớt và lọc dầu',
    },
    {
      id: 4,
      name: 'Kiểm tra phanh',
    ...
    },
    {
      ...
      name: 'Cân bằng lốp',
      price: 200000,
      description: 'Cân bằng và kiểm tra áp suất lốp',
    },
    {
      id: 6,
      name: 'Rửa xe chi tiết',
      price: 150000,
      description: 'Rửa xe chuyên nghiệp, làm sạch nội thất',
    },
  ];
              ...
              <div style={{ maxWidth: '800px' }}>
                ...
                <div
                  style={{
                    ...
                    animation:
                      currentSlide === index
                        ? 'fadeInUp 1s ease-out 0.9s both'
                        : 'none',
                  }}
                >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Chúng tôi cam kết mang đến trải nghiệm dịch vụ tốt nhất với những
              ưu điểm vượt trội
            </p>
          </div>
