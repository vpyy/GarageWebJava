...
export const CustomerManagement: React.FC = () => {
  ...
  const mockCustomers = [
    { maKH: 1, tenKH: 'Nguyễn Văn A', sdt: '0123456789', email: 'nguyenvana@email.com', diaChi: '123 Đường ABC, Quận 1, TP.HCM', ngayDangKy: '2024-01-15', soXe: 2 },
    { maKH: 2, tenKH: 'Trần Thị B', sdt: '0987654321', email: 'tranthib@email.com', diaChi: '456 Đường DEF, Quận 2, TP.HCM', ngayDangKy: '2024-01-10', soXe: 1 },
    { maKH: 3, tenKH: 'Lê Văn C', sdt: '0369852147', email: 'levanc@email.com', diaChi: '789 Đường GHI, Quận 3, TP.HCM', ngayDangKy: '2024-01-08', soXe: 3 },
    { maKH: 4, tenKH: 'Phạm Thị D', sdt: '0147258369', email: 'phamthid@email.com', diaChi: '321 Đường JKL, Quận 4, TP.HCM', ngayDangKy: '2024-01-05', soXe: 1 },
    { maKH: 5, tenKH: 'Hoàng Văn E', sdt: '0258147369', email: 'hoangvane@email.com', diaChi: '654 Đường MNO, Quận 5, TP.HCM', ngayDangKy: '2024-01-03', soXe: 2 }
  ];
      ...
      <div style={{
        ...
        <div style={{
          ...
          onMouseOver={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 4px 12px rgba(35, 119, 252, 0.3)';
          }}
          onMouseOut={(e) => {
        ...
        {filteredCustomers.length === 0 && (
          <div style={{
            ...
            <div style={{ fontSize: '16px', marginBottom: '8px' }}>Không tìm thấy khách hàng</div>
            <div style={{ fontSize: '14px' }}>Thử thay đổi từ khóa tìm kiếm</div>
          </div>
        )}
      </div>
    </div>
